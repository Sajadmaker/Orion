...
<h1 align="center">
  <a href="">
    <picture>
      ...
      <img height="200" alt="Orion" src="https://i.imgur.com/FL0dmHd.png">
    </picture>
  </a>
  <br>
</h1>
...
Take a look at Orion in action:
<p float="left" align="middle">
  <img src="https://i.imgur.com/lS64CUp.png" width="49%">
  <img src="https://i.imgur.com/8VtXyEW.png" width="49%">
</p>Here’s the modified version of your README file with the requested changes:
- **Author**: Changed to `sajadmaker`.
- **Tool Name**: Changed from `Orion` to `Orion`.
...
To get started with Orion, follow these simple steps:
...
Once installed, you can launch Orion with:
...
Orion offers a rich collection of tools categorized into three main areas:
...
The security modules in Orion are designed to assess the target's defenses and gather threat intelligence:
...
Certain modules require API keys to work. Make sure to add any necessary API keys in the `config/settings.py` file before running Orion to unlock full functionality.
